...
public class CustomerServiceTesting implements CommandLineRunner {
	...
	public void customerLoginTesting() {
	...
	public void getCustomerCoponsByCategoryTesting() {
		...
		PrintUtils.printResultList(customerService.getCustomerCoupon(Category.SPORT));
	}
	...
	public void getCustomerCoponsByMaxPriceTesting() {
		...
		PrintUtils.printResultList(customerService.getCustomerCoupon(60));
	}
