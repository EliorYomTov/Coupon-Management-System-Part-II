...
public class LoginManagerTesting implements CommandLineRunner {
	...
	public void loginManagerAdminTesting() throws CouponSystemException {
	...
	public void loginManagerCompanyTesting() throws CouponSystemException, InterruptedException {
	...
	public void loginManagerCompanyOneTesting() throws CouponSystemException {
	...
	public void loginManagerCompanyTwoTesting() throws CouponSystemException, InterruptedException {
	...
	public void loginManagerCustomerTesting() throws CouponSystemException {
	...
	public void loginManagerCustomerOneTesting() throws CouponSystemException {
		...
		CustomerService customerService = (CustomerService) loginManager.login("TzachShar76@gmail.com", "1234",
				ClientType.CUSTOMER);
		PrintUtils.printResultList(customerService.getCustomerCoupon());
		System.out.println();
	}

	public void loginManagerCustomerTowTesting() throws CouponSystemException {
